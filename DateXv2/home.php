...
<body>
   ...
   <form class="insert" action="save_dates.php" method="post">
      <div class="topinfo">
      <h2 class="tableTitle">Προσθήκη</h2>
      <div class="docInfoContainer">
         ...
         <input type="text" class="docid" name="docid" value="" autocomplete="off" placeholder="Αρ. Παραστατικού">
         <input type="text" class="datepicker" name="del_date" value="" autocomplete="off" placeholder="Ημ/νία Παραλαβής">
      </div>
      </div>
      ...
      <div class="submit"><img src="img/save_icon3.png" alt="save"></div>
