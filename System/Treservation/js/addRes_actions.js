...
//	if($('#drop_office').val()!=''){
//		$('input[name=SellerID]').prop('disabled', false);
//	}
//});
...
//        console.log('hotel: '+hname+' exc: '+exc_name);
//        $.ajax({ 
//			url: 'getDefaultPPoint.php',
//			type: 'POST',
//			cache: false,
//			data: {hotel:hname, exc:exc_name},
//			success: function(data){
//				console.log(data);
//                $('input[name=PPoint]').val(data);
//			}
//		});
//    }
//});
